...
app.include_router(commercialization_router, prefix="/api/v1", tags=['Commercialization'])
app.include_router(importation_router, prefix="/api/v1", tags=['Importation'])
app.include_router(exportation_router, prefix="/api/v1", tags=['Exportation'])